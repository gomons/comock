...
namespace doctest { namespace internal {
    static DOCTEST_CONSTEXPR int consume(const int*, int) noexcept { return 0; }
}}

#define DOCTEST_GLOBAL_NO_WARNINGS(var, ...)                                                         \
    DOCTEST_CLANG_SUPPRESS_WARNING_WITH_PUSH("-Wglobal-constructors")                                \
    static const int var = doctest::internal::consume(&var, __VA_ARGS__);                              \
    DOCTEST_CLANG_SUPPRESS_WARNING_POP
...
struct ContextOptions //!OCLINT too many fields
{
    ...
    const internal::TestCase* currentTest = nullptr;
...
// MSVS 2015 :(
    ...
    struct should_stringify_as_underlying_type {
        static DOCTEST_CONSTEXPR bool value = internal::types::is_enum<T>::value && !doctest::internal::has_insertion_operator<T>::value;
    };
...
template <typename T>
struct StringMaker : public internal::StringMakerBase<
    internal::has_insertion_operator<T>::value || internal::types::is_pointer<T>::value || internal::types::is_array<T>::value>
{};
...
template <typename T, typename internal::types::enable_if<!internal::should_stringify_as_underlying_type<T>::value, bool>::type = true>
...
template <typename T, typename internal::types::enable_if<internal::should_stringify_as_underlying_type<T>::value, bool>::type = true>
String toString(const DOCTEST_REF_WRAP(T) value) {
    using UT = typename internal::types::underlying_type<T>::type;
...
#else
#define SFINAE_OP(ret,op) decltype((void)(doctest::internal::declval<L>() op doctest::internal::declval<R>()),ret{})
#endif

#define DOCTEST_DO_BINARY_EXPRESSION_COMPARISON(op, op_str, op_macro)                              \
    template <typename R>                                                                          \
    DOCTEST_NOINLINE SFINAE_OP(Result,op) operator op(R&& rhs) {                                   \
    bool res = op_macro(doctest::internal::forward<const L>(lhs), doctest::internal::forward<R>(rhs)); \
...
DOCTEST_CLANG_SUPPRESS_WARNING_POP
    ...
    struct DOCTEST_INTERFACE ExpressionDecomposer
    {
        ...
        template <typename L,typename types::enable_if<!doctest::internal::types::is_rvalue_reference<L>::value,void >::type* = nullptr>
...
#define DOCTEST_BINARY_RELATIONAL_OP(n, op) \
    ...
    DOCTEST_BINARY_RELATIONAL_OP(0, doctest::internal::eq)
    DOCTEST_BINARY_RELATIONAL_OP(1, doctest::internal::ne)
    DOCTEST_BINARY_RELATIONAL_OP(2, doctest::internal::gt)
    DOCTEST_BINARY_RELATIONAL_OP(3, doctest::internal::lt)
    DOCTEST_BINARY_RELATIONAL_OP(4, doctest::internal::ge)
    DOCTEST_BINARY_RELATIONAL_OP(5, doctest::internal::le)
...
#define DOCTEST_DEFINE_DECORATOR(name, type, def)                                                  \
    ...
    {                                                                                              \
        ...
        name(type in = def)                                                                        \
                : data(in) {}                                                                      \
        void fill(internal::TestCase& state) const { state.DOCTEST_CAT(m_, name) = data; }           \
        void fill(internal::TestSuite& state) const { state.DOCTEST_CAT(m_, name) = data; }          \
    }
...
int registerExceptionTranslator(String (*translateFunction)(T)) {
    ...
    static internal::ExceptionTranslator<T> exceptionTranslator(translateFunction);
    DOCTEST_CLANG_SUPPRESS_WARNING_POP
    internal::registerExceptionTranslatorImpl(&exceptionTranslator);
    return 0;
}
...
DOCTEST_INTERFACE doctest::internal::TestSuite& getCurrentTestSuite();
} // namespace doctest_detail_test_suite_ns
...
public:
    ...
    void setAssertHandler(internal::assert_handler ah);
...
int registerReporter(const char* name, int priority, bool isReporter) {
    internal::registerReporterImpl(name, priority, internal::reporterCreator<Reporter>, isReporter);
    return 0;
}
} // namespace doctest
...
#define DOCTEST_REGISTER_FUNCTION(global_prefix, f, decorators)                                    \
    global_prefix DOCTEST_GLOBAL_NO_WARNINGS(DOCTEST_ANONYMOUS(DOCTEST_ANON_VAR_), /* NOLINT */    \
            doctest::internal::regTest(                                                              \
                    doctest::internal::TestCase(                                                     \
                            f, __FILE__, __LINE__,                                                 \
...
#define DOCTEST_CREATE_AND_REGISTER_FUNCTION_IN_CLASS(f, proxy, decorators)                        \
    static doctest::internal::funcType proxy() { return f; }                                         \
    ...
    namespace { /* NOLINT */                                                                       \
        ...
        {                                                                                          \
            iter(const char* file, unsigned line, int index) {                                     \
                doctest::internal::regTest(doctest::internal::TestCase(func<Type>, file, line,         \
                                            doctest_detail_test_suite_ns::getCurrentTestSuite(),   \
...
#define DOCTEST_TEST_CASE_TEMPLATE_INSTANTIATE_IMPL(id, anon, ...)                                 \
    DOCTEST_GLOBAL_NO_WARNINGS(DOCTEST_CAT(anon, DUMMY), /* NOLINT(cert-err58-cpp, fuchsia-statically-constructed-objects) */ \
        doctest::internal::instantiationHelper(                                                      \
...
#define DOCTEST_SUBCASE(name)                                                                      \
    if(const doctest::internal::Subcase & DOCTEST_ANONYMOUS(DOCTEST_ANON_SUBCASE_) DOCTEST_UNUSED =  \
               doctest::internal::Subcase(name, __FILE__, __LINE__))

// for grouping tests in test suites by using code blocks
#define DOCTEST_TEST_SUITE_IMPL(decorators, ns_name)                                               \
    namespace ns_name { namespace doctest_detail_test_suite_ns {                                   \
            static DOCTEST_NOINLINE doctest::internal::TestSuite& getCurrentTestSuite() noexcept {   \
                DOCTEST_MSVC_SUPPRESS_WARNING_WITH_PUSH(4640)                                      \
                DOCTEST_CLANG_SUPPRESS_WARNING_WITH_PUSH("-Wexit-time-destructors")                \
                DOCTEST_GCC_SUPPRESS_WARNING_WITH_PUSH("-Wmissing-field-initializers")             \
                static doctest::internal::TestSuite data{};                                          \
...
#define DOCTEST_TEST_SUITE_BEGIN(decorators)                                                       \
    DOCTEST_GLOBAL_NO_WARNINGS(DOCTEST_ANONYMOUS(DOCTEST_ANON_VAR_), /* NOLINT(cert-err58-cpp) */  \
            doctest::internal::setTestSuite(doctest::internal::TestSuite() * decorators))              \
    static_assert(true, "")

// for ending a testsuite block
#define DOCTEST_TEST_SUITE_END                                                                     \
    DOCTEST_GLOBAL_NO_WARNINGS(DOCTEST_ANONYMOUS(DOCTEST_ANON_VAR_), /* NOLINT(cert-err58-cpp) */  \
            doctest::internal::setTestSuite(doctest::internal::TestSuite() * ""))                      \
...
#define DOCTEST_INFO_IMPL(mb_name, s_name, ...)                                       \
    auto DOCTEST_ANONYMOUS(DOCTEST_CAPTURE_) = doctest::internal::MakeContextScope(                  \
        [&](std::ostream* s_name) {                                                                \
        doctest::internal::MessageBuilder mb_name(__FILE__, __LINE__, doctest::assertType::is_warn); \
...
#define DOCTEST_ADD_AT_IMPL(type, file, line, mb, ...)                                             \
    DOCTEST_FUNC_SCOPE_BEGIN {                                                                     \
        doctest::internal::MessageBuilder mb(file, line, doctest::assertType::type);                 \
        mb * __VA_ARGS__;                                                                          \
        if(mb.log())                                                                               \
            DOCTEST_BREAK_INTO_DEBUGGER();                                                         \
        mb.react();                                                                                \
...
#define DOCTEST_ASSERT_IMPLEMENT_2(assert_type, ...)                                               \
    ...
    doctest::internal::ResultBuilder DOCTEST_RB(doctest::assertType::assert_type, __FILE__,          \
                                               __LINE__, #__VA_ARGS__);                            \
    DOCTEST_WRAP_IN_TRY(DOCTEST_RB.setResult(                                                      \
            doctest::internal::ExpressionDecomposer(doctest::assertType::assert_type)                \
...
#define DOCTEST_BINARY_ASSERT(assert_type, comp, ...)                                              \
    DOCTEST_FUNC_SCOPE_BEGIN {                                                                     \
        doctest::internal::ResultBuilder DOCTEST_RB(doctest::assertType::assert_type, __FILE__,      \
                                                   __LINE__, #__VA_ARGS__);                        \
        DOCTEST_WRAP_IN_TRY(                                                                       \
                DOCTEST_RB.binary_assert<doctest::internal::binaryAssertComparison::comp>(           \
                        __VA_ARGS__))                                                              \
        DOCTEST_ASSERT_LOG_REACT_RETURN(DOCTEST_RB);                                               \
    } DOCTEST_FUNC_SCOPE_END
...
#define DOCTEST_ASSERT_THROWS_AS(expr, assert_type, message, ...)                                  \
    DOCTEST_FUNC_SCOPE_BEGIN {                                                                     \
        if(!doctest::getContextOptions()->no_throw) {                                              \
            ...
            } catch(const typename doctest::internal::types::remove_const<                           \
                    typename doctest::internal::types::remove_reference<__VA_ARGS__>::type>::type&) {\
...
#define DOCTEST_WARN_EQ(...) [&] { return doctest::internal::eq(__VA_ARGS__); }()
#define DOCTEST_CHECK_EQ(...) [&] { return doctest::internal::eq(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_EQ(...) [&] { return doctest::internal::eq(__VA_ARGS__); }()
#define DOCTEST_WARN_NE(...) [&] { return doctest::internal::ne(__VA_ARGS__); }()
#define DOCTEST_CHECK_NE(...) [&] { return doctest::internal::ne(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_NE(...) [&] { return doctest::internal::ne(__VA_ARGS__); }()
#define DOCTEST_WARN_LT(...) [&] { return doctest::internal::lt(__VA_ARGS__); }()
#define DOCTEST_CHECK_LT(...) [&] { return doctest::internal::lt(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_LT(...) [&] { return doctest::internal::lt(__VA_ARGS__); }()
#define DOCTEST_WARN_GT(...) [&] { return doctest::internal::gt(__VA_ARGS__); }()
#define DOCTEST_CHECK_GT(...) [&] { return doctest::internal::gt(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_GT(...) [&] { return doctest::internal::gt(__VA_ARGS__); }()
#define DOCTEST_WARN_LE(...) [&] { return doctest::internal::le(__VA_ARGS__); }()
#define DOCTEST_CHECK_LE(...) [&] { return doctest::internal::le(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_LE(...) [&] { return doctest::internal::le(__VA_ARGS__); }()
#define DOCTEST_WARN_GE(...) [&] { return doctest::internal::ge(__VA_ARGS__); }()
#define DOCTEST_CHECK_GE(...) [&] { return doctest::internal::ge(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_GE(...) [&] { return doctest::internal::ge(__VA_ARGS__); }()
...
doctest::internal::TestSuite& getCurrentTestSuite() {
    static doctest::internal::TestSuite data{};
    return data;
}
} // namespace doctest_detail_test_suite_ns
...
void Context::setAssertHandler(internal::assert_handler ah) { p->ah = ah; }
...
int IReporter::get_num_active_contexts() { return internal::g_infoContexts.size(); }
const IContextScope* const* IReporter::get_active_contexts() {
    return get_num_active_contexts() ? &internal::g_infoContexts[0] : nullptr;
}

int IReporter::get_num_stringified_contexts() { return internal::g_cs->stringifiedContexts.size(); }
const String* IReporter::get_stringified_contexts() {
    return get_num_stringified_contexts() ? &internal::g_cs->stringifiedContexts[0] : nullptr;
}
